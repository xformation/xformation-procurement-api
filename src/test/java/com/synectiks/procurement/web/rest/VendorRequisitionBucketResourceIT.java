...
//import com.synectiks.procurement.IntegrationTest;
...
@WithMockUser
class VendorRequisitionBucketResourceIT {
  ...
  private static final String ENTITY_API_URL = "/api/vendor-requisition-buckets";
  ...
  @Test
  @Transactional
  void createVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeCreate = vendorRequisitionBucketRepository.findAll().size();
    // Create the VendorRequisitionBucket
    restVendorRequisitionBucketMockMvc
      .perform(
        post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vendorRequisitionBucket))
      )
  ...
  @Test
  @Transactional
  void createVendorRequisitionBucketWithExistingId() throws Exception {
  ...
  @Test
  @Transactional
  void getAllVendorRequisitionBuckets() throws Exception {
  ...
  @Test
  @Transactional
  void getVendorRequisitionBucket() throws Exception {
    // Initialize the database
    vendorRequisitionBucketRepository.saveAndFlush(vendorRequisitionBucket);

    // Get the vendorRequisitionBucket
    restVendorRequisitionBucketMockMvc
      .perform(get(ENTITY_API_URL_ID, vendorRequisitionBucket.getId()))
      .andExpect(status().isOk())
      .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  @Test
  @Transactional
  void getNonExistingVendorRequisitionBucket() throws Exception {
    // Get the vendorRequisitionBucket
    restVendorRequisitionBucketMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
  }

  @Test
  @Transactional
  void putNewVendorRequisitionBucket() throws Exception {
    // Initialize the database
    vendorRequisitionBucketRepository.saveAndFlush(vendorRequisitionBucket);
    ...
    VendorRequisitionBucket updatedVendorRequisitionBucket = vendorRequisitionBucketRepository
    ...
    restVendorRequisitionBucketMockMvc
      .perform(
        put(ENTITY_API_URL_ID, updatedVendorRequisitionBucket.getId())
  ...
  @Test
  @Transactional
  void putNonExistingVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());

    // If the entity doesn't have an ID, it will throw BadRequestAlertException
    restVendorRequisitionBucketMockMvc
      .perform(
        put(ENTITY_API_URL_ID, vendorRequisitionBucket.getId())
          .contentType(MediaType.APPLICATION_JSON)
  ...
  @Test
  @Transactional
  void putWithIdMismatchVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void putWithMissingIdPathParamVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());
    ...
    restVendorRequisitionBucketMockMvc
      .perform(
        put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vendorRequisitionBucket))
      )
  ...
  @Test
  @Transactional
  void partialUpdateVendorRequisitionBucketWithPatch() throws Exception {
    // Initialize the database
    vendorRequisitionBucketRepository.saveAndFlush(vendorRequisitionBucket);

    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();

    // Update the vendorRequisitionBucket using partial update
    VendorRequisitionBucket partialUpdatedVendorRequisitionBucket = new VendorRequisitionBucket();
    partialUpdatedVendorRequisitionBucket.setId(vendorRequisitionBucket.getId());

    partialUpdatedVendorRequisitionBucket.createdOn(UPDATED_CREATED_ON).updatedOn(UPDATED_UPDATED_ON);

    restVendorRequisitionBucketMockMvc
      .perform(
        patch(ENTITY_API_URL_ID, partialUpdatedVendorRequisitionBucket.getId())
          .contentType("application/merge-patch+json")
          .content(TestUtil.convertObjectToJsonBytes(partialUpdatedVendorRequisitionBucket))
      )
      .andExpect(status().isOk());
  ...
  @Test
  @Transactional
  void fullUpdateVendorRequisitionBucketWithPatch() throws Exception {
    // Initialize the database
    vendorRequisitionBucketRepository.saveAndFlush(vendorRequisitionBucket);
    ...
    partialUpdatedVendorRequisitionBucket
      .status(UPDATED_STATUS)
      .stages(UPDATED_STAGES)
      .createdOn(UPDATED_CREATED_ON)
      .createdBy(UPDATED_CREATED_BY)
  ...
  @Test
  @Transactional
  void patchNonExistingVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());
    ...
    restVendorRequisitionBucketMockMvc
      .perform(
        patch(ENTITY_API_URL_ID, vendorRequisitionBucket.getId())
          .contentType("application/merge-patch+json")
          .content(TestUtil.convertObjectToJsonBytes(vendorRequisitionBucket))
      )
      .andExpect(status().isBadRequest());
  ...
  @Test
  @Transactional
  void patchWithIdMismatchVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void patchWithMissingIdPathParamVendorRequisitionBucket() throws Exception {
    int databaseSizeBeforeUpdate = vendorRequisitionBucketRepository.findAll().size();
    vendorRequisitionBucket.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void deleteVendorRequisitionBucket() throws Exception {
    // Initialize the database
    vendorRequisitionBucketRepository.saveAndFlush(vendorRequisitionBucket);
    ...
    restVendorRequisitionBucketMockMvc
      .perform(delete(ENTITY_API_URL_ID, vendorRequisitionBucket.getId()).accept(MediaType.APPLICATION_JSON))
